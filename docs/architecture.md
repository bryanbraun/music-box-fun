...
- The frontend is built in a custom JS framework [based on ReactJS](https://www.bryanbraun.com/2019/09/11/alt-react/) that has no build process and no dependencies. It's written in plain, modern, Javascript, organized into ES6 modules, which is supported by all modern web browsers. For more details see [the alt-react README](../site/public/js/alt-react/README.md).
